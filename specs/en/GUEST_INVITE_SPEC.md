...
- Notification system for guest events
...
| Member notification | Everyone stays informed | Potential notification fatigue |
...
5. System notifies all house members
6. Other members can view guest details
7. System sends reminder before arrival
8. Guest period expires automatically

**Post-condition:** Guest visit recorded and all members informed
...
sequenceDiagram
    ...
    Frontend->>Notification: Notify all members
    Notification-->>Member: Confirmation

    Note over Contract: At arrival time
    Contract->>Contract: Activate invite
    Contract->>Notification: Guest arriving alert
```
