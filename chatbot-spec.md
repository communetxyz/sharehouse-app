...
classDiagram
    ...
    class PlatformAdapterA {
        +sendInteractiveMessage()
        +handlePlatformWebhook()
    }
 
    class PlatformAdapterB {
        +sendInteractiveMessage()
        +handlePlatformWebhook()
    }
    ...
    ChatbotAdapter <|-- PlatformAdapterA
    ChatbotAdapter <|-- PlatformAdapterB
    PlatformAdapterA --> TaskService
    PlatformAdapterB --> TaskService
...
sequenceDiagram
    ...
    ChatPlatform->>Webhook: POST /webhook/{platform}
...
- **Rich Message:** Platform-specific interactive message format (e.g., buttons, cards, quick replies)
- **Interactive Message:** Platform-native format for actionable messages with buttons or quick actions
